...
from PyQt5.QtWidgets import QWidget, QLabel, QHBoxLayout, QLineEdit, QListWidget, QPushButton, QFrame, QGraphicsDropShadowEffect, QScrollArea, QComboBox
from FlowLayout import FlowLayout


class DropDown (QComboBox):

    def __init__(self, parent, onShowPopup):
...
class InputItemWithDelete (QFrame):
    ...
    def __init__(self, parent, api, onRemove):
        ...
        self.dropdown = DropDown(self, onDropDownClick)
