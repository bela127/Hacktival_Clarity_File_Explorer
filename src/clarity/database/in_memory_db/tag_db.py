...
class Tag_db():
    ...
    def tags_contain(self, text):
        return [tag for tag in self.tag_storage if text in tag.name]
    ...
    def add_tag(self, name, tags):
        ...
        self.tag_storage.append(new_tag)
        for tag in tags:
